    ...
    <script>
        function getAllUsers()
        {
            ...
            $( '#dtViewUsers tbody' ).on( 'click', '.print', function ()
            {
                ...
                var vTown = vClosestTr.find( 'td' ).eq( 5 ).text();
                $( '#spTown' ).text( vTown );

                var vCountry = vClosestTr.find( 'td' ).eq( 6 ).text();
                $( '#spCountry' ).text( vCountry );

                var vPostCode = vClosestTr.find( 'td' ).eq( 7 ).text();
                $( '#spPostCode' ).text( vPostCode );

                var vMobile = vClosestTr.find( 'td' ).eq( 8 ).text();
                $( '#spMobile' ).text( vMobile );

                var vTelephone = vClosestTr.find( 'td' ).eq( 9 ).text();
                $( '#spTelephone' ).text( vTelephone );

                var vUserRole = vClosestTr.find( 'td' ).eq( 10 ).text();
                $( '#spUserRole' ).text( vUserRole );
            ...
            $( '#dtViewUsers tbody' ).on( 'click', '.edit', function ()
            {
                ...
                if ( hasWhiteSpace( vUserName ) )
                {
                    var spaceCount = countWhiteSpace( vUserName );
                    if ( spaceCount == 1 )
                    {
                        var Names = vUserName.split( ' ' );
                        ...
                        <div class="panel-body clrBLK box_bg">
                            ...
                            <div id="dvUserDetails" class="panel-body clrBLK col-md-10 dashboad-form"
                                style="margin-left: 100px;">
                                    ...
                                    <div class="row">
                                        <div class="form-group"><label class="col-sm-4 control-label">Telephone (+44)</label>
                                            <div class="col-sm-6">
