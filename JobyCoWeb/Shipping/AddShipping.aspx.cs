    ...
    public partial class AddShipping : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                #region Shipping
                if (HttpContext.Current.Session["ShippingDetails"] != null)
                {
                    EntityLayer.Shippings objShipping = new EntityLayer.Shippings();
                    objShipping = (Shippings)HttpContext.Current.Session["ShippingDetails"];

                    txtShippingReferenceNumber.Text =  objShipping.ShippingId;
                    txtSealReferenceNumber.Text = objShipping.SealId;
                    txtShippingDate.Text = objShipping.sShippingDate;
                    txtETA.Text = objShipping.sETA;
                    txtConsignee.Text = objShipping.Consignee;
                    ddlGhanaPort.SelectedValue = objShipping.GhanaPort;
                }
                #endregion
            }
        }
        ...
        public static object GetContainerDetails(string ContainerNo, string SearchKey)
        {
            ...
            DataTable dtBookingInfo = objDB.GetContainerDetails(ContainerNo, SearchKey, "Add");
        ...
        {
            List<BookingInformationForShipping> ListBookingInfo = new List<BookingInformationForShipping>();
            DataTable dtBookingInfo = objDB.GetBookingInformationByBookingId(BookingId, "Add");
            foreach (DataRow drBookingInfo in dtBookingInfo.Rows)
            {
                BookingInformationForShipping BookingInfo = new BookingInformationForShipping();
                BookingInfo.BookingId = drBookingInfo["BookingId"].ToString();
        ...
        [WebMethod]
        public static void RemoveShippingDetails
            (
            string ContainerId,
            string BookingId,
            string PickupId
            ...
            )
        {
            ...
            objDB.RemoveShippingItems(objShipping);
        }
            ...
            )
        {
            ...
            objShipping.ShippingId = ShippingId;
            objShipping.SealId = SealId;
            objShipping.sShippingDate = ShippingDate;
            objShipping.sETA = ETA;
            objShipping.Consignee = Consignee;
            objShipping.GhanaPort = GhanaPort;
            HttpContext.Current.Session["ShippingDetails"] = objShipping;
