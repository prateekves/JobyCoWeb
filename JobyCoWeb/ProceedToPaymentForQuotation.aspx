<%@ Page Title="" Language="C#" MasterPageFile="~/JobyCoWithoutMenuBar.Master" AutoEventWireup="true" CodeBehind="ProceedToPaymentForQuotation.aspx.cs" Inherits="JobyCoWeb.ProceedToPaymentForQuotation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="paymentMNdiv" style="background-color: #484848; background-size:cover; height:100vh; width:100%;">
        <div class="">
            <div class="container">
                <div class="row">
                                    ...
                                    <div class="details clrBLK">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <asp:TextBox ID="txtPayPalName" runat="server" MaxLength="50" ReadOnly="true"
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    <asp:TextBox ID="txtPayPalEmailId" runat="server" ReadOnly="true"
                                                        CssClass="form-control"  PlaceHolder="e.g. example@gmail.com"
                                                        title="Please enter PayPal Email Id" MaxLength="100"
