...
namespace JobyCoWeb
{
    public partial class ResetPassword : System.Web.UI.Page
    {
        ...
        public static string SendResetLinkByEmail(string RegisteredEmailID, string EncryptedEmailID)
        {
            ...
            sBody += "<a href='" + authorityDomain + "/ChangePassword.aspx?RegisteredEmailID=" + EncryptedEmailID + "'><b><u>Reset your Password</u></b></a>.</p>";
            sBody += "<p>After changing your password you can also sign into the ";
            sBody += "<a href='" + authorityDomain + "/Login.aspx'><b><u>Admin Portal</u></b></a>";
