<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" 
    CodeBehind="AssignBookingToDriver.aspx.cs" Inherits="JobyCoWeb.Booking.AssignBookingToDriver"
...
<script>
    ...
    function getAllUnassignedBookings()
    {
        $.ajax( {
            method: "POST",
            contentType: "application/json; charset=utf-8",
            url: "AssignBookingToDriver.aspx/GetAllUnassignedBookings",
            beforeSend: function () {
                //$("#loadingDiv").show();
    ...
    function showSpecificBookings()
    {
        if ( checkFewControls() )
        {
            ...
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "AssignBookingToDriver.aspx/GetAllUnassignedSpecificBookings",
...
<%--        DriverType = $( '#<%=hfDriverType.ClientID%>' ).val().trim();
            ...
            if (OrderStatus != "Cancelled") {
                ...
                $.ajax({
                    method: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "AssignBookingToDriver.aspx/AddAssignBookingToDriver",
                    ...
                    success: function (result) {
                        ...
                        $.ajax({
                            method: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "AssignBookingToDriver.aspx/UpdateIsAssignedInOrderBooking",
