...
{
    public partial class PrintDriverJob : System.Web.UI.Page
    {
        ...
        {
            DataTable dtAssignedBooking = objDB.GetAllAssignedBookings(DriverId, "");
        ...
        {
            DataTable dtDriverJobs = objDB.GetAllDrivers("UK");
