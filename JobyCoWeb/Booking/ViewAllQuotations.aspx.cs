...
{
    public partial class ViewAllQuotations : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string GetAllQuotations()
        {
            DataTable dtQuotation = objDB.GetAllQuotations();
            List<EntityLayer.AllQuotations> lstQuotation = new List<EntityLayer.AllQuotations>();

            foreach (DataRow drQuotation in dtQuotation.Rows)
            {
                EntityLayer.AllQuotations objQuotation = new EntityLayer.AllQuotations();
        ...
        //        objQuotation.QuotingId = drQuotation["QuotingId"].ToString();
        //        objQuotation.CustomerName = drQuotation["CustomerName"].ToString();
        //        objQuotation.PickupCategory = drQuotation["PickupCategory"].ToString();
        //        objQuotation.PickupItem = drQuotation["PickupItem"].ToString();
        ...
        {
            DataTable dtQuotations = objDB.GetAllQuotations();
