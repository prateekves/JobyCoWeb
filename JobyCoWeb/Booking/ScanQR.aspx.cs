...
namespace JobyCoWeb.Booking
{
    public partial class ScanQR : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static object SearchByContainerNoORBookingNo(string ItemNoORBookingNo)
        {
            List<BookingInformationForShipping> ListBookingInfo = new List<BookingInformationForShipping>();
            DataTable dtBookingInfo = objDB.SearchByItemNoORBookingNo(ItemNoORBookingNo);
            foreach (DataRow drBookingInfo in dtBookingInfo.Rows)
            {
                ...
                BookingInfo.QRCode = getQRbase64ImageCode(drBookingInfo["QRCode"].ToString());
                BookingInfo.IsFragile = Convert.ToBoolean(drBookingInfo["IsFragile"].ToString());
        ...
        private static string getQRbase64ImageCode(string QRCode)
        {
            string code = QRCode;
