<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="NewTaxation.aspx.cs" Inherits="JobyCoWeb.Taxation.NewTaxation" %>
...
================================================== -->
    <script>
        ...
        $('#dtTaxRangeTable').on('click', 'input[type="button"]', function (e) {
            ...
            $('#dtViewBookings tbody').on('click', '.edit', function (e) {
                ...
                $.ajax({
                    ...
                    url: "NewTaxation.aspx/GetAllTaxationForEdit",
                    ...
                    success: function (result) {
                        ...
                        if (IsRange)
                        {
                            ...
                            $.ajax({
                                method: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "NewTaxation.aspx/GetAllTaxationForEditRange",
                                data: JSON.stringify(objTaxation),
                                success: function (result) {
                                    var jdata = JSON.parse(result.d);
                                    //alert(JSON.stringify(jdata));
        ...
        function getTaxation()
        {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "NewTaxation.aspx/GetAllTaxation",
                success: function (result) {
        ...
        function deleteTransaction(ChargesId, AddOrEdit, Chargestxt) {
            ...
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "NewTaxation.aspx/DeleteTaxation",
                data: JSON.stringify(objTaxation),
                success: function (result) {
                    if (result.d) {
                        if (AddOrEdit == "Add")
    ...
    function addRowToRange() {
        ...
        function checkTaxNameExistance(vTaxationName)
        {
            ...
            $.ajax({
                type: "POST",
                url: "NewTaxation.aspx/checkTaxNameExistance",
                contentType: "application/json; charset=utf-8",
                data: JSON.stringify(objTaxation),
                dataType: "json",
                async: false,
        ...
        function saveTaxation() {
            ...
            if ($("#IsRange").is(':checked')) {
                ...
                $('#dtTaxRangeTable tbody tr').each(function (i, row) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "NewTaxation.aspx/AddTaxation",
                        contentType: "application/json; charset=utf-8",
                        data: JSON.stringify(objTaxation),
                        dataType: "json",
                        success: function (result) {
                ...
                if (validateFlatControls())
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "NewTaxation.aspx/AddFlatTaxation",
                        contentType: "application/json; charset=utf-8",
                        data: JSON.stringify(objTaxation),
                        dataType: "json",
                        success: function (result) {
