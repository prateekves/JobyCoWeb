<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" 
    CodeBehind="ViewAllQuotations.aspx.cs" Inherits="JobyCoWeb.Booking.ViewAllQuotations" %>
...
<script>
    ...
    <script>
        ...
        function viewQuotationDetails( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/ViewQuotationDetails",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
                    var jsonQuotingDetails = JSON.parse( result.d );
                    $( '#dvAllQuotationDetails' ).DataTable( {
                ...
                error: function ( response )
                {
                    alert( 'Unable to View Quoting Details' );
                }
            } );//end of ajax
        }
        ...
        function getAllQuotations()
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetAllQuotations",
                data: "{}",
                contentType: "application/json; charset=utf-8",
                success: function ( result )
                {
    ...
    <script>
        function getBookingId() {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetBookingId",
                data: "{}",
                success: function ( result )
                {
        ...
        function getCustomerIdFromQuotationId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerIdFromQuotationId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
        ...
        function getPickupCategoryFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupCategoryFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
    ...
    <script>
        ...
        function getCustomerIdFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerIdFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerMobileFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerMobileFromCustomerId",
        ...
        function getPickupNameFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupNameFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getPickupAddressFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupAddressFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getPickupMobileFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupMobileFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getDeliveryNameFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryNameFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getDeliveryAddressFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryAddressFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getDeliveryMobileFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryMobileFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getPickupDateAndTimeFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupDateAndTimeFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getVATfromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetVATfromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getOrderTotalFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetOrderTotalFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getOrderStatusFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetOrderStatusFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getIsFragileFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetIsFragileFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getItemCountFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetItemCountFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getQuotingNotesFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetQuotingNotesFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getInsurancePremiumFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetInsurancePremiumFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getPickupPostCodeFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupPostCodeFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getDeliveryPostCodeFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryPostCodeFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getQuotingDateFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetQuotingDateFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getPickupEmailFromQuotingId( QuotingId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupEmailFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function ( result )
                {
        ...
        function getDeliveryEmailFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryEmailFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
        ...
        function getEstimatedValueFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetEstimatedValueFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
        ...
        function getPickupItemFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetPickupItemFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
        ...
        function getDeliveryDateTimeFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetDeliveryDateTimeFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
        ...
        function getWhetherOtherExistsFromQuotingId(QuotingId) {
            $.ajax({
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetWhetherOtherExistsFromQuotingId",
                data: "{ QuotingId: '" + QuotingId + "'}",
                success: function (result) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "ViewAllQuotations.aspx/AddBookingOperation",
                        contentType: "application/json; charset=utf-8",
                        ...
                        success: function (result) {
                            ...
                            $('#dvAllQuotationDetails tbody > tr').each(function () {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "ViewAllQuotations.aspx/AddBookPickup",
                                    contentType: "application/json; charset=utf-8",
                            ...
                            $.ajax({
                                type: "POST",
                                url: "ViewAllQuotations.aspx/UpdateQuotationFlag",
                                contentType: "application/json; charset=utf-8",
                                data: "{ QuotingId: '" + QuotingId + "'}",
                                dataType: "json",
                                success: function (result) {
    ...
    <script>
        function getCustomerIdFromCustomerName(CustomerName)
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerIdFromCustomerName",
        ...
        function getCustomerEmailIdFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerEmailIdFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerDOBFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerDOBFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerAddressFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerAddressFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerPostCodeFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerPostCodeFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerMobileNoFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerMobileNoFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
                ...
                error: function ( response )
                {
                    alert( 'Unable to Bind Customer Mobile in Span' );
                }
            } );
        }
        ...
        function getCustomerLandlineFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerLandlineFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getCustomerHearAboutUsFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetCustomerHearAboutUsFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getHavingRegisteredCompanyFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetHavingRegisteredCompanyFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getRegisteredCompanyNameFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetRegisteredCompanyNameFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
        ...
        function getShippingGoodsInCompanyNameFromCustomerId( CustomerId )
        {
            $.ajax( {
                method: "POST",
                contentType: "application/json; charset=utf-8",
                url: "ViewAllQuotations.aspx/GetShippingGoodsInCompanyNameFromCustomerId",
                data: "{ CustomerId: '" + CustomerId + "'}",
                success: function ( result )
                {
                    var vResult = result.d.toString().toLowerCase();
    ...
    <script>
        ...
        function clearQuotationModalPopup() {
            ...
            $('#dvAllQuotationDetails tbody').empty();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hpanel">
                    <form id="frmViewQuotation" runat="server">
                            ...
                            <div class="col-md-12">
                                <div class="twoSETbtn">
                                    ...
                                    <button id="btnPrintExcelQuotationModal" data-dismiss="modal" title="Download as Excel"
                                        onclick="exportToExcel('dvAllQuotationDetails', 'CustomerDetails.xls');" style="margin-bottom:10px;">
                                            ...
                                            <div class="confirm-details">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <!-- jQuery DataTable -->
                                                        <table id="dvAllQuotationDetails" style="width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    <th>Item</th>
                                                                    <th>IsFragile</th>
    ...
    <div class="modal fade" id="dvBookingDetailsModal" role="dialog">
        <div class="modal-dialog modal-lg">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tblBookingOwnDetails">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span id="spPickupCategory"></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Is Fragile: </th>
                                                ...
                                                <tr>
                                                    <th>Estimated Value: </th>
                                                    <td><span id="spEstimatedValue"></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Pickup Item: </th>
                                                    <td><span id="spPickupItem"></span></td>
                                                </tr>
                                                <tr>
                                                    <th>Delivery DateTime: </th>
                                                    <td><span id="spDeliveryDateTime"></span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
