<%@ Page Title="" Language="C#" MasterPageFile="~/JobyCoWithoutMenuBar.Master" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" Inherits="JobyCoWeb.Signup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        function checkBlankTextBoxes() {
            ...
            var SignupEmailAddress = $("#<%=lblSignupEmailAddress.ClientID%>");
            SignupEmailAddress.html("<b>" + vEmailID + "</b>");
            ...
            //var timeDuration = 2000;
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        vErrMsg.css("display", "none");
                        //vErrMsg.show(timeDuration).delay(timeDuration).fadeOut(timeDuration);
                        //$("#dvSignupEmail").show(500);
                    },
                    error: function (response) {
        ...
        <div class="fromPad">
         <div class="loginForm">
            ...
            <asp:TextBox ID="txtName" CssClass="form-control" 
                    ...
                    MaxLength="100" onkeypress="CharacterOnly(event);clearErrorMessage();" runat="server"
                    ></asp:TextBox>
            ...
            <!--<div class="success alert alert-success alert-dismissable" role="alert" id="dvSignupEmail"
                style="display: none; background-color: whitesmoke; border-radius: 10px; width: 400px;">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close"
                    onclick="closeSuccessDialog();">
                    <span aria-hidden="true">&times;</span></button>
                &nbsp;&nbsp;<b>Confirmation Email Sent!</b> A Confirmation Email has been sent to 
                <asp:Label ID="lblSignupEmailAddress" runat="server" Text=""></asp:Label>
                If you have not received this quote in 5 minutes, please check your spam folder.
            </div>-->
