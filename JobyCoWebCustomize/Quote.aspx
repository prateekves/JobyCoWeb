<%@ Page Title="" Language="C#" MasterPageFile="~/LoggedJobyCo.Master" AutoEventWireup="true"
    CodeBehind="Quote.aspx.cs" Inherits="JobyCoWebCustomize.Quote" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function addRowBookPickup()
    {
        ...
        vMyTableRow += '<td class="col-sm-2 col-xs-12"><label class="float_label">£</label><input id="txtPredefinedEstimatedValue' + counter + '" name="predefinedestimatedValue[] class="estimatevalue" placeholder="e.g. £123.45" readonly="readonly" title="" type="text"  style="padding-left: 40px;" /></td>';
        ...
        vMyTableRow += '<td class="col-sm-1 col-xs-12"><label class="brwsBtn" for="upload' + (counter + 1) + '">Upload an image (optional)<input class="isVisuallyHidden" id="upload' + (counter + 1) + '" name="upload[]" type="file" accept="image/*" onchange="loadFile(event, \'output' + (counter + 1) + '\')" multiple  /></label></td>';
        vMyTableRow += '<td class="col-sm-1 col-xs-12"><a class="btn-danger deleteRow btn-sm ibtnDel"><span class="glyphicon glyphicon-minus remove"></span></a></td>';
        vMyTableRow += "</tr>";
    ...
    <script>
        function getPickupCategories()
        {
            $.ajax( {
                ...
                url: "Quote.aspx/GetPickupCategories",
                data: "{}",
                dataType: "json",
        ...
        function getPickupItemsByCategory( PickupCategory )
        {
            $.ajax( {
                type: "POST",
                url: "Quote.aspx/GetPickupItemsByCategory",
        ...
        function getPredefinedEstimatedValueByCategory()
        {
            ...
            $.ajax( {
                type: "POST",
                url: "Quote.aspx/GetPredefinedEstimatedValueByCategory",
                data: '{ PickupCategory: "' + PickupCategory + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function ( result )
        ...
        function getPredefinedEstimatedValueByItem()
        {
            ...
            $.ajax( {
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Quote.aspx/GetPredefinedEstimatedValueByItem",
        ...
        function generateQuoteId()
        {
            $.ajax( {
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Quote.aspx/GenerateQuoteId",
                data: "{}",
                dataType: "json",
                success: function ( result )
                {
        ...
        function sendQuotingByEmail( EmailID, jQueryDataTableContent )
        {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Quote.aspx/SendQuoteByEmail",
            ...
            $.ajax( {
                type: "POST",
                url: "Quote.aspx/RemoveImagePickup",
                contentType: "application/json; charset=utf-8",
    ...
    <script>
        ...
        function saveQuoting()
        {
            ...
            $.ajax( {
                ...
                success: function ( result )
                {
                    ...
                    $.ajax( {
                        type: "POST",
                        url: "Quote.aspx/AddQuotingOperation",
                        contentType: "application/json; charset=utf-8",
        ...
        function proceedToPayment()
        {
            ...
            var EmailID = $( "#<%=txtPickupEmailAddress.ClientID%>" ).val().trim();
                ...
                setTimeout( function ()
                {
                    location.href = '/ProceedToPaymentForQuotation.aspx?QuoteId=' + QuoteId;
                }, 3000 );
            }
        ...
        <div class="row">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #f0ad4ecf;">
                                    ...
                                    <h4 class="modal-title" style="font-size: 24px; color: #111;">Quotation</h4>
                                </div>
                                <div class="modal-body" style="text-align: center; font-size: 22px;">
                                    <p>Wish to Book A Quotation Now?</p>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-warning" data-dismiss="modal" onclick="placeOrder();">Yes</button>
                                    <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="cancelQuoting();">No</button>
                                </div>
                            </div>
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="text-align: center; font-size: 22px;">
                                    ...
                                    <br />
                                    <strong>Your Current Bill is: </strong>
                                    <i class="note-disclaimer"><i>: £
            <span id="spCurrentBill" runat="server"></span></i></i>
                                    <br />
                                    <strong>Your Earlier Payment was: </strong>
                                    <i class="note-disclaimer"><i>: £
            ...
            <span id="spHaveToPay" runat="server"></span></i></i>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="cancelEdit();">No</button>
                                </div>
                            </div>
