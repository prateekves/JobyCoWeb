...
(function (window, document) {
  ...
  window.sweetAlertInitialize = function () {
    var sweetHTML = '<div class="sweet-overlay" tabIndex="-1"></div>' +
            ...
            '<h2>Title</h2><p class="lead text-muted">Text</p>' +
  ...
  window.sweetAlert = window.swal = function () {
    ...
    switch (typeof arguments[0]) {
      ...
      case 'object':
        ...
        params.showLoader = arguments[0].showLoader || defaultParams.showLoader;
        ...
        params.onOpen = arguments[0].onOpen || defaultParams.onOpen;
        ...
        case ("click"):
          if (targetedConfirm && doneFunctionExists && modalIsVisible) { // Clicked "confirm"
            ...
            if (params.showLoader) {
              $('.btn-container .confirm', modal).html("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
              $('.la-ball-fall', modal).css("visibility", "visible");
              $(".btn", modal).prop("disabled", true);
            }

            if (params.closeOnConfirm) {
              closeModal();
              $('.btn-container .confirm', modal).text(escapeHtml(params.confirmButtonText));
              $('.la-ball-fall', modal).css("visibility", "hidden");
            }
