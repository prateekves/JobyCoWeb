<%@ Page Title="" Language="C#" MasterPageFile="~/JobyCoForOtherLoggedOns.Master" AutoEventWireup="true" 
    CodeBehind="LoggedContactUs.aspx.cs" Inherits="JobyCoWebCustomize.LoggedContactUs"
     EnableEventValidation="false" %>

<%@ MasterType VirtualPath="~/JobyCoForOtherLoggedOns.Master" %>
...
<div class="inner_ban">
    <figure>
        <img src="/images/jobyco-in.jpg" alt="" class="img-responsive" />
    </figure>	
</div>	
        	...
        	<div class="row">
                ...
                <div class="col-md-6">
                	<div class="abt-cnt-BG adrsSEC">
                        ...
                        <p>While we prefer to be contacted via the form, we can be contacted by phone or snail mail.</p>
                        <div class="row">
