<%@ Page Title="" Language="C#" MasterPageFile="~/JobyCoWithoutMenuBar.Master" AutoEventWireup="true" CodeBehind="ViewMyQuotations.aspx.cs" Inherits="JobyCoWebCustomize.ViewMyQuotations" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center welcome-message">
                <h2 class="whtCLR">View My Quotations</h2>
                <p></p>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="panel-body clrBLK col-md-12">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <br /><br />
                                    <div style="width: 100%; margin-left: 310px;">
                      ...
                      <div class="modal fade" id="dvQuotation" role="dialog">
                        <div class="modal-dialog modal-lg">
                          ...
                          <div class="modal-content qtngDtailsPOP">
                            ...
                            <div class="row">
                                <!--<div class="col-md-12">
                                    <p><strong>Please find the details of order #BOOK000000009 below:</strong></p>
                                </div>-->
